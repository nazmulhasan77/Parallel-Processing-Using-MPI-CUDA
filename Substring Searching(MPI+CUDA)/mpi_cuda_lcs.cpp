...
// mpicxx -O2 -o mpi_cuda_lcs mpi_cuda_lcs.cpp -lcudart -L/usr/local/cuda/lib64
// Or with nvcc + MPI:
// nvcc -O2 -arch=sm_75 mpi_cuda_lcs.cpp -o mpi_cuda_lcs -lmpi
